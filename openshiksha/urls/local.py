...
from sphinx.views import deal_post, tags_get, submit_sphinx_question_post
...
def get_sphinx_urlpatterns():
    return [
        ...
        url(SphinxUrlNames.SUBMIT_SPHINX_QUESTION.url_matcher, dynamic_router, {HttpMethod.POST: submit_sphinx_question_post},
            name=SphinxUrlNames.SUBMIT_SPHINX_QUESTION.name),
