        ...
        >
          ...
          <div className="min-w-0">
            <h2 className="font-display text-lg font-semibold text-ink-900 group-hover:text-brand-700">
              {t('register.joinSchoolTitle')}
            </h2>
            <p className="mt-1 text-sm text-ink-500">{t('register.joinSchoolDesc')}</p>
          </div>
        </Link>
        ...
        >
          ...
          <div className="min-w-0">
            <h2 className="font-display text-lg font-semibold text-ink-900 group-hover:text-emerald-700">
              {t('register.openTitle')}
            </h2>
            <p className="mt-1 text-sm text-ink-500">{t('register.openDesc')}</p>
          </div>
        </Link>
      </div>
    </AuthLayout>
