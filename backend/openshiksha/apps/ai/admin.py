...
class LearningPathStepInline(admin.TabularInline):
    ...
    extra = 0
    readonly_fields = ['position', 'knowledge_node', 'problem_set', 'status', 'is_review', 'score_when_completed', 'completed_at']
    can_delete = False
...
class StudentMasteryAdmin(admin.ModelAdmin):
    list_display = [
        'student', 'knowledge_node', 'mastery_level', 'mastery_score',
...
class SpacedRepetitionEntryAdmin(admin.ModelAdmin):
    list_display = [
        'student', 'knowledge_node', 'next_review_date', 'interval_days',
...
class LearningPathAdmin(admin.ModelAdmin):
    list_display = [
        'student', 'subject_room', 'status', 'total_steps', 'completed_steps', 'generated_at',
    ]
